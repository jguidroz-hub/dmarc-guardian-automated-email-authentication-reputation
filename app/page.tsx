  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">DMARC Guardian - Automated Email Authentication & Reputation</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Simplifies DMARC, SPF, and DKIM setup and continuous monitoring for small to medium businesses, preventing email spoofing, improving deliverability, and protecting sender reputation against cyber threats.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust DMARC Guardian - Automated Email Authentication & Reputation.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} DMARC Guardian - Automated Email Authentication & Reputation. All rights reserved.</p>
