...
const FROM = process.env.EMAIL_FROM || 'DMARC Guardian - Automated Email Authentication & Reputation <noreply@example.com>';
const APP_NAME = 'DMARC Guardian - Automated Email Authentication & Reputation';
